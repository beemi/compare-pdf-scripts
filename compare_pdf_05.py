...
def find_and_draw_differences(img1, img2):
    """Find differences between two images and draw a red rectangle around grouped differences in the second image."""
    ...
    # Draw a single rectangle around merged contours
    if contours:
        # Calculate the combined bounding rectangle for all contours
...
output_pdf_path = 'output_highlighted_difference_05_07.pdf'
